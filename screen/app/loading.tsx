  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-6 z-10 text-center">
        {/* Cross animation */}
        <div className="text-5xl animate-bounce" role="img" aria-label="Cross">
          ✝️
        </div>
        ...
        {/* Spinner */}
        <div 
          className="w-10 h-10 border-4 border-gray-200 border-t-yellow-500 rounded-full animate-spin mt-2"
          role="status"
          aria-label="Loading"
        >
          <span className="sr-only">Loading Pastor Daniel Tiruwa Ministry...</span>
        </div>
      </div>
    </div>
  );
