...
export const metadata: Metadata = {
  title: 'Page Not Found | Pastor Daniel Tiruwa Ministry',
  description: 'The page you are looking for could not be found. Return to Pastor Daniel Tiruwa Ministry homepage.',
  robots: {
    index: false,
    follow: true,
  },
...
export default function NotFound() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-white via-blue-50 to-white text-center">
      ...
      <div className="relative z-10 px-6">
        ...
        <nav className="mt-6" aria-label="Helpful links">
          <p className="text-sm text-slate-500 mb-3">You might be looking for:</p>
